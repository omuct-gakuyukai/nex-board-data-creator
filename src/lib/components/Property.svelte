<script lang="ts">
	...
	const isGroupInvalid = $derived(/[^a-zA-Z0-9_().-]/.test(editorState.groupName));
	const isSongInvalid = $derived(/[^a-zA-Z0-9_().-]/.test(editorState.songName));
</script>
...
<div class="flex items-start px-5 py-3">
	...
	<div class="mx-2 flex flex-col"></div>
	<div
